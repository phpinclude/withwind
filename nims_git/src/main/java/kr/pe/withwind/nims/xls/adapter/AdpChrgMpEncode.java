...
public class AdpChrgMpEncode implements NimsAdpInf{
	...
	public void getData(Header header, Line line, String param) throws NimsException {
		try {
			...
			header.setCHRGMPNO(RSAEncrypt.EncryptRsa(param,pubKey));
		}catch(Exception e) {
			throw new NimsException("AdpChrgMpEncode : 담당자 휴대번호 암호화중 오류가 발생하였습니다.", e);
		}
	}
}
