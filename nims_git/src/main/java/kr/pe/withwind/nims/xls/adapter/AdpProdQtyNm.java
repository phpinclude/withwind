...
public class AdpProdQtyNm implements NimsAdpInf {
	...
	public void getData(Header header, Line line, String param) throws NimsException {
		try {
			...
			line.setPRDMINDISTBUNIT(pInfo.getMinQtyNm());
		}catch(NimsException e) {
			throw e;
		}catch(Exception e) {
			throw new NimsException("AdpProdQtyNm : 제품최소유통단위 셋팅중 오류가 발생하였습니다.", e);
		}
	}
}
