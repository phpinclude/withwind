...
public class DestpCallController extends CommonController{
	
	private final Logger logger = LogManager.getLogger(this.getClass());
	
	// 검색 파라메터용
	@FXML
	private TextField tfParamC; // 상대업체 취급자식별번호
	...
	private void doSearch() {
		...
		try{
			...
			ArrayList<JSONObject> result = mainClass.doTaskExcute(CALL_TYPE.DESTP_INFO,urlParam);
			...
			Platform.runLater(()->{DialogManager.showExceptionDialog(e, "에러", "상대업체 구입정보 조회 실패", "내용을 확인해주세요.");});
